...
OpenPose::OpenPose() :  outputSize(op::flagsToPoint(FLAGS_output_resolution, "-1x-1")),
                        ...
                        cliVerbose(false),
                        writeCocoFootJson(""),
                        writeCocoJsonVariant(0),
                        writeVideoFps(0.0),
                        writeVideoAdam(""),
                        writeBvh(""),
                        udpHost(""),
                        udpPort(""),
                        wrapperStructOutput(cliVerbose, FLAGS_write_keypoint, op::stringToDataFormat(FLAGS_write_keypoint_format),
                                            FLAGS_write_json, FLAGS_write_coco_json, writeCocoFootJson, writeCocoJsonVariant,
                                            FLAGS_write_images, FLAGS_write_images_format, FLAGS_write_video, writeVideoFps,
                                            FLAGS_write_heatmaps, FLAGS_write_heatmaps_format, writeVideoAdam, writeBvh, udpHost,
                                            udpPort)
